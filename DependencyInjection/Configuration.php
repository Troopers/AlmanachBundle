                    ...
                    ->children()
                        ->arrayNode('classGrid')
                            ->children()
                                ...
                                ->scalarNode('xs_8')->end()
                                ->scalarNode('xs_9')->end()
                                ->scalarNode('xs_10')->end()
                                ->scalarNode('xs_11')->end()
                                ->scalarNode('xs_12')->end()
                                ->scalarNode('sm_1')->end()
                                ->scalarNode('sm_2')->end()
                                ->scalarNode('sm_3')->end()
                                ->scalarNode('sm_4')->end()
                                ...
                                ->scalarNode('sm_8')->end()
                                ->scalarNode('sm_9')->end()
                                ->scalarNode('sm_10')->end()
                                ->scalarNode('sm_11')->end()
                                ->scalarNode('sm_12')->end()
                                ->scalarNode('md_1')->end()
                                ->scalarNode('md_2')->end()
                                ->scalarNode('md_3')->end()
                                ->scalarNode('md_4')->end()
                                ...
                                ->scalarNode('md_8')->end()
                                ->scalarNode('md_9')->end()
                                ->scalarNode('md_10')->end()
                                ->scalarNode('md_11')->end()
                                ->scalarNode('md_12')->end()
                                ->scalarNode('lg_1')->end()
                                ->scalarNode('lg_2')->end()
                                ->scalarNode('lg_3')->end()
                                ->scalarNode('lg_4')->end()
                                ...
                                ->scalarNode('lg_8')->end()
                                ->scalarNode('lg_9')->end()
                                ->scalarNode('lg_10')->end()
                                ->scalarNode('lg_11')->end()
                                ->scalarNode('lg_12')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
